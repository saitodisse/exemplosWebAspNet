<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AspNet-jQuery-post.aspx.cs"
         Inherits="ExemplosWebAspNetWebApplication.jQuery.AspNet_jQuery_post" ViewStateMode="Disabled" ClientIDMode="Static"%>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        <title>jQuery, post serialize</title>
    </head>
    <body>
        <a href="../Default.aspx">Voltar</a>
        <h1>
            jQuery, post serialize</h1>
        ...
        <script type="text/javascript">
            $("#btEnviar").click(function() {
                $.post("AspNet-jQuery-post.aspx?jQueryPost=1",
