<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AspNet-UpdatePanel-sem-ViewState.aspx.cs"
         Inherits="ExemplosWebAspNetWebApplication.updatePanel.AspNet_UpdatePanel_sem_ViewState" ViewStateMode="Disabled" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        <title>UpdatePanel, ViewState OFF</title>
    </head>
    <body>
        <a href="../Default.aspx">Voltar</a>
        <h1>
            UpdatePanel, ViewState OFF</h1>
